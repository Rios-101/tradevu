...
const transactions = [
    ...
    { id: 4, title: 'From S&B Incorporated', amount: '+ ₦190,000.00', time: '7:18 AM', status: 'Completed', balance: '₦4,415,000.20', date: 'Fri 19 Jul' },
    ...
    return (
        <div className="p-4 bg-white shadow rounded-lg">
            <div className="flex justify-between items-center mb-4">
                ...
                <button className="bg-gray-100 md:text-base text-xxs text-gray-700 px-4 py-2 rounded-md">
                    Print statement
                </button>
            </div>
                    ...
                    <div key={index}>
                        ...
                        <div key={transaction.id} className="flex justify-between items-center">
                            ...
                            <div className="text-right">
                                <p className={`font-semibold md:text-base text-xs ${transaction.amount.startsWith('-') ? 'text-red-500' : 'text-green-500'}`}>
                                    {transaction.amount}
                                </p>
